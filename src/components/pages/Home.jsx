...
export const Home = () => {
  ...
  const getProducto = async () => {
    try {
      ...
      console.log("Respuesta axios --> ", respuesta);
    ...
    <div className="fondoPrincipal">
      <div>
        <Carousel variant="dark">
          ...
          <Carousel.Item>
            <div text="Segunda Imagen Slider" />
      ...
      <div className="fondoSecundario text-center">
        {/* <h2>RollingCosmetic: Cuidado de la piel, Cabello, Coloración, Maquillaje</h2> */}
        <h1>RollingCosmetic</h1>
        <p>Cuidado de la piel, Cabello, Coloración, Maquillaje</p>
      </div>
      <div className="container">
        <div className="orden d-flex">
          ...
          <div className="box2 d-flex my-5 ">
            <Container>
              <Row>
